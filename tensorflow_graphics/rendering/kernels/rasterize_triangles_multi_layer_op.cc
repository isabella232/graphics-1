...
REGISTER_OP("RasterizeTrianglesMultiLayer")
...
class RasterizeTrianglesMultiLayerOp : public OpKernel {
 public:
  explicit RasterizeTrianglesMultiLayerOp(OpKernelConstruction* context)
      : OpKernel(context) {
  ...
  ~RasterizeTrianglesMultiLayerOp() override {}
  ...
  void Compute(OpKernelContext* context) override {
    ...
    OP_REQUIRES(
        ...
        InvalidArgument("RasterizeTrianglesMultiLayer expects vertices to have "
                        "shape (-1, 4)."));
    ...
    OP_REQUIRES(
        ...
        InvalidArgument(
            "RasterizeTrianglesMultiLayer expects triangles to be a matrix."));
 ...
 private:
  TF_DISALLOW_COPY_AND_ASSIGN(RasterizeTrianglesMultiLayerOp);
...
REGISTER_KERNEL_BUILDER(Name("RasterizeTrianglesMultiLayer").Device(DEVICE_CPU),
                        RasterizeTrianglesMultiLayerOp);
